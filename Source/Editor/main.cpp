...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
{
    ...
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("Diablo3D Editor"), NULL };
    ::RegisterClassEx(&wc);
    ...
    params.myHwnd = &hwnd;
    params.myWindowHeight = 500;
    params.myWindowWidth = 500;
    params.myPresentFunction = [&](ID3D11ShaderResourceView* resource) {
        const ImVec2 first = ImGui::GetWindowPos();
        const ImVec2 second = ImGui::GetWindowSize();
